...
class FirebaseStorageManager {
    ...
    static let manager = FirebaseStorageManager()
    ...
    func storeImage(type: ImageType, uid: String, image: UIImage) {
        ...
        let uploadTask = FirebaseStorageManager.manager.imagesRef.child(uid).putData(data, metadata: metadata) { (storageMetadata, error) in
            if let error = error {
